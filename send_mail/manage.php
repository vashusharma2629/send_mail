 ...
 //add record
                ...
                $DisplayForm = "<p>Thanks for signing up!</p>";
 ...
 //print failure message
                       $DisplayForm = "<p>You're already subscribed!</p>";
                     }
           }
 ...
 //print failure message
                                                            $DisplayForm = "<p>Couldn’t find your address!</p>
 ...
 //unsubscribe the address
                              ...
                              $DisplayForm= "<p>You’re unsubscribed!</p>";
                            }
                      mysqli_close($mysqli);
                   }
          } 
